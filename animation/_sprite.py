...
class Sprite():
    def __init__(self):
        ...
        self.__weapons = sprite_sheet.get_weapons()

        # danh sách các trạng thái của các loại đạn
        self.__bullets = sprite_sheet.get_bullets()

        # danh sách các trạng thái của các vật phẩm
        self.__items = sprite_sheet.get_items()

        # danh sách các trạng thái của các vật khác
        self.__backgrounds = sprite_sheet.get_backgrounds()
